...
import br.com.erudio.integrationtests.vo.wrappers.Book.WrapperBookVO;
...
public class BookControllerJsonTest extends AbstractIntegrationTest {
    ...
    public void authorization() {
        AccountCredentialVO user = new AccountCredentialVO();
...
//                        .getAccessToken();
        ...
        specification =
                new RequestSpecBuilder()
                        .addHeader(TestConfigs.HEADER_PARAM_ORIGIN, "Bearer " + token)
